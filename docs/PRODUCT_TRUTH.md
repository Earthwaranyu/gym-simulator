...
|---|---|---|
| World size | **35 stations—7 tiers × 5 muscles**, 2012 instances / 1835 BaseParts, build `580b192a698f`; all 35 machine and pose definitions are playable exactly once | `scripts/validate_gym.py` |
...
4. **The repeated-machine version in #110 is superseded.** Each muscle now has seven
   structurally and procedurally distinct exercises, one at every tier. The city still spans
   roughly 3,000 × 2,700 studs; every muscle has one +1/s starter, five shuffled intermediate
   exercises including one third-floor secret, and one +64/s flight-only skyline exercise.
