...
| Ground movement | walk 16; hold **LeftShift** to sprint from 24 toward a Legs-scaled cap of 64, on both islands and walkable water | `Formulas.WalkSpeed/SprintSpeed`, `SprintChanged` |
...
4. **The repeated-machine and connected-city versions are superseded.** Each muscle has
   seven structurally and procedurally distinct exercises, one at every tier, scattered
   across a bridge-free archipelago. Every muscle has one +1/s starter, five shuffled
   intermediate exercises including one third-floor secret, and one +64/s skyline exercise.
