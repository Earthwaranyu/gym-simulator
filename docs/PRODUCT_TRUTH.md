...
| Client controllers | 17 | `[Loader/Client] Ignited 17 systems` |
...
| Finding a machine | the **Train** tab lists every station for a chosen muscle with live free/busy counts, polled every 2s while open | `MenuController:_renderTrain`, `TrainingService:GetSpotStatus` |
