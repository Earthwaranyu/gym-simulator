...
3. **Client-Server Boundary**: Client handles UI/inputs. Server handles stat math, stamina drain, and DataStores.
...
5. **Player can pvp**: Players can kill other players while they are training to annoy them.
